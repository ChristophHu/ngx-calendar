...
function getElementRect(element: ElementRef, ghostElementPositioning: string): BoundingRectangle {
  ...
  if (ghostElementPositioning === 'absolute') {
    ...
    return { height: boundingRect.height, width: boundingRect.width, top: boundingRect.top - translateY, bottom: boundingRect.bottom - translateY, left: boundingRect.left - translateX, right: boundingRect.right - translateX, scrollTop: element.nativeElement.scrollTop, scrollLeft: element.nativeElement.scrollLeft }
  }
}
...
function getEdgesDiff({ edges, initialRectangle, newRectangle }: { edges: Edges; initialRectangle: BoundingRectangle; newRectangle: BoundingRectangle }): Edges {
